...
public class ToggleButton extends View{
	...
	/** 开启颜色*/
	private int onColor = GalleryFinal.getGalleryTheme().getTitleBarBgColor();
	/** 关闭颜色*/
	...
	public void checkToggle(boolean isUsefull, String tip) {
		this.isUsefull = isUsefull;
		this.tip = TextUtils.isEmpty(tip) ? "按钮不可用" : tip;
	}
	...
	public void setup(AttributeSet attrs) {
		...
		this.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				if(!isUsefull) {
					ToastUtil.showToast(getContext(), tip);
				} else {
	...
	public void setToggleStatus(boolean isOn) {
		if(isOn) {
			toggleOn();
		} else {
			toggleOff();
