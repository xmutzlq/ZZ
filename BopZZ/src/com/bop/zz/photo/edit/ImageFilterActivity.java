...
import com.bop.zz.R;
import com.bop.zz.photo.edit.view.VerticalSeekBar;
...
//				updatePicture(degree);
	...
	private void updatePicture(float degree) {
		...
		resultImg = Bitmap.createBitmap(dataResult, srcWidth, srcHeight, Bitmap.Config.ARGB_8888);
	...
	private TextView filterWhite, filterGray, filterMosatic, filterLOMO, filterNostalgic, filterComics,
			filterBlackWhite, filterNegative, filterBrown, filterSketchPencil, filterOverExposure, filterSoftness,
			filterNiHong, filterSketch, filterCarving, filterSelief, filterRuiHua;
