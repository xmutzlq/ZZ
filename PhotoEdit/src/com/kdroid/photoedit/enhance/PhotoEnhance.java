package com.kdroid.photoedit.enhance;
	...
	public Bitmap handleImage(int type) {
		...
		case Enhance_Brightness:
			...
			brightnessMatrix.set(
					new float[] { 1, 0, 0, 0, brightNum, 0, 1, 0, 0, brightNum, 0, 0, 1, 0, brightNum, 0, 0, 0, 1, 0 });
			break;
		case Enhance_Contrast:
			...
			contrastMatrix.set(new float[] { contrastNum, 0, 0, 0, regulateBright, 0, contrastNum, 0, 0, regulateBright,
